...
<script>
    ...
    const birdDataset = [
        ...
        { name: 'Blue & Gold Macaw', sci: 'Ara ararauna', origin: 'Amazon Basin', life: '50-70 Years', price: 2800, volume: 'Loud', friendly: true, intel: 'Playful Genius', category: 'macaws', tag: 'Classic Giant', image: 'images/scarlet_macaw.png', care: 'Affectionate giant parrot with vibrant yellow belly and sky blue wings. Requires big aviary.' },
        { name: 'Hyacinth Macaw', sci: 'Anodorhynchus hyacinthinus', origin: 'Brazil', life: '60 Years', price: 4800, volume: 'Loud', friendly: false, intel: 'Genius Level', category: 'macaws', tag: 'Gentle Giant', image: 'images/hyacinth_macaw.png', care: 'Requires custom extra-heavy steel aviary, macadamia nuts, and expert handling.' },
        { name: 'Green-Winged Macaw', sci: 'Ara chloropterus', origin: 'South America', life: '50-80 Years', price: 3500, volume: 'Loud', friendly: true, intel: 'Affectionate Master', category: 'macaws', tag: 'Majestic Red', image: 'images/scarlet_macaw.png', care: 'Second largest macaw species, known for sweet nature and deep crimson plumage.' },
        { name: 'Hahn\'s Macaw', sci: 'Diopsittaca nobilis', origin: 'South America', life: '30-40 Years', price: 950, volume: 'Moderate', friendly: true, intel: 'Compact Talker', category: 'macaws', tag: 'Mini Macaw', image: 'images/sun_conure.png', care: 'Smallest macaw breed, packed with full macaw personality in an apartment-sized body.' },

        // --- 3. COCKATIELS (5 Unique Mutations) ---
        ...
        { name: 'Pearl Cockatiel', sci: 'Nymphicus hollandicus', origin: 'Australia', life: '15-20 Years', price: 230, volume: 'Quiet', friendly: true, intel: 'Patterned Whistler', category: 'cockatiels', tag: 'Pearl Mutation', image: 'images/cockatiel.png', care: 'Features delicate yellow and grey scalloped pearls on wings. Loving and vocal.' },
        { name: 'Whiteface Cockatiel', sci: 'Nymphicus hollandicus', origin: 'Australia', life: '15-20 Years', price: 260, volume: 'Quiet', friendly: true, intel: 'Quiet Whistle', category: 'cockatiels', tag: 'Silver Mutation', image: 'images/cockatiel.png', care: 'Striking charcoal grey body with pure white cheeks and no orange blush patches.' },
        { name: 'Cinnamon Cockatiel', sci: 'Nymphicus hollandicus', origin: 'Australia', life: '15-20 Years', price: 220, volume: 'Quiet', friendly: true, intel: 'Gentle Mimic', category: 'cockatiels', tag: 'Warm Tone', image: 'images/cockatiel.png', care: 'Warm cinnamon-tan feathers with soft yellow crest and sweet whistling tone.' },
        { name: 'Pied Cockatiel', sci: 'Nymphicus hollandicus', origin: 'Australia', life: '15-20 Years', price: 210, volume: 'Quiet', friendly: true, intel: 'Active Learner', category: 'cockatiels', tag: 'Patchwork Crest', image: 'images/cockatiel.png', care: 'Randomized yellow and grey patchwork plumage making every bird uniquely distinct.' },

        // --- 4. BUDGIES (5 Unique Mutations) ---
        ...
        { name: 'English Exhibition Budgie', sci: 'Melopsittacus undulatus', origin: 'United Kingdom', life: '7-12 Years', price: 180, volume: 'Quiet', friendly: true, intel: 'Calm Talker', category: 'budgies', tag: 'Show Grade', image: 'images/budgie.png', care: 'Larger show-sized budgie with fluffy head cap and calm, steady demeanor.' },
        { name: 'Rainbow Budgie', sci: 'Melopsittacus undulatus', origin: 'Australia', life: '5-10 Years', price: 140, volume: 'Quiet', friendly: true, intel: 'Vibrant Mimic', category: 'budgies', tag: 'Rainbow Gradient', image: 'images/budgie.png', care: 'Stunning yellow head, clearwing pastel body, and blue opaline wing gradient.' },
        { name: 'Albino Budgie', sci: 'Melopsittacus undulatus', origin: 'Australia', life: '5-10 Years', price: 120, volume: 'Quiet', friendly: true, intel: 'Pure White', category: 'budgies', tag: 'Snow White', image: 'images/budgie.png', care: 'Pure snow-white feathers with ruby pink eyes. Gentle and quiet companion.' },
        { name: 'Opaline Budgie', sci: 'Melopsittacus undulatus', origin: 'Australia', life: '5-10 Years', price: 110, volume: 'Quiet', friendly: true, intel: 'Active Whistler', category: 'budgies', tag: 'V-Back Pattern', image: 'images/budgie.png', care: 'Features clear V-shaped mantle back pattern with bright turquoise belly.' },

        // --- 5. LOVEBIRDS (5 Unique Species) ---
        ...
        { name: 'Fischer\'s Lovebird', sci: 'Agapornis fischeri', origin: 'East Africa', life: '12-15 Years', price: 220, volume: 'Moderate', friendly: true, intel: 'Energetic Pair', category: 'lovebirds', tag: 'Energetic', image: 'images/lovebird.png', care: 'Playful active bird, requires pair caging and mineral blocks for beak health.' },
        { name: 'Masked Lovebird', sci: 'Agapornis personatus', origin: 'Tanzania', life: '12-15 Years', price: 240, volume: 'Moderate', friendly: true, intel: 'Playful Acrobat', category: 'lovebirds', tag: 'Black Mask', image: 'images/lovebird.png', care: 'Distinctive jet-black head mask with bright white eye-rings and yellow chest.' },
        { name: 'Abyssinian Lovebird', sci: 'Agapornis taranta', origin: 'Ethiopia', life: '12-15 Years', price: 350, volume: 'Quiet', friendly: true, intel: 'Quiet Companion', category: 'lovebirds', tag: 'Rare Species', image: 'images/lovebird.png', care: 'Largest lovebird species, quiet and gentle with emerald green body and red forehead.' },
        { name: 'Nyasa Lovebird', sci: 'Agapornis lilianae', origin: 'Malawi', life: '10-14 Years', price: 260, volume: 'Moderate', friendly: true, intel: 'Sweet Flocker', category: 'lovebirds', tag: 'Lilian Lovebird', image: 'images/lovebird.png', care: 'Charming small lovebird with warm salmon orange head and lime green body.' },

        // --- 6. CANARIES (5 Unique Varieties) ---
        { name: 'Red Factor Canary', sci: 'Serinus canaria', origin: 'Canary Islands', life: '10-12 Years', price: 160, volume: 'Quiet', friendly: true, intel: 'Famed Songbird', category: 'canaries', tag: 'Beautiful Voice', image: 'images/canary.png', care: 'Famed singing bird, requires carotenoid-rich diet for feather color preservation.' },
        { name: 'Yellow Crested Canary', sci: 'Serinus canaria', origin: 'Canary Islands', life: '10-12 Years', price: 150, volume: 'Quiet', friendly: true, intel: 'Crowned Singer', category: 'canaries', tag: 'Bright Yellow', image: 'images/canary.png', care: 'Classic bright canary yellow with rich melodious whistling song.' },
        { name: 'Gloster Canary', sci: 'Serinus canaria', origin: 'England', life: '10-12 Years', price: 190, volume: 'Quiet', friendly: true, intel: 'Cute Crested', category: 'canaries', tag: 'Corona Crest', image: 'images/canary.png', care: 'Adorable small canary famous for its mop-top circular hair crest.' },
        { name: 'Roller Canary', sci: 'Serinus canaria', origin: 'Germany', life: '10-12 Years', price: 210, volume: 'Quiet', friendly: true, intel: 'Low Chime Vocalist', category: 'canaries', tag: 'Opera Singer', image: 'images/canary.png', care: 'Bred specifically for soft, rolling, continuous song tours with beak closed.' },
        { name: 'Border Canary', sci: 'Serinus canaria', origin: 'Scotland', life: '10-12 Years', price: 175, volume: 'Quiet', friendly: true, intel: 'Loud Whistling', category: 'canaries', tag: 'Round Posture', image: 'images/canary.png', care: 'Distinctive round posture and glossy feathers. Excellent loud, crisp singing.' },

        // --- 7. FINCHES (5 Unique Species) ---
        { name: 'Zebra Finch', sci: 'Taeniopygia guttata', origin: 'Australia', life: '5-8 Years', price: 40, volume: 'Quiet', friendly: true, intel: 'Peeping Flocker', category: 'finches', tag: 'Best Seller', image: 'images/finch.png', care: 'Peaceful flocking bird, needs flight room, small seed blend, and water bath dish.' },
        { name: 'Gouldian Finch', sci: 'Erythrura gouldiae', origin: 'Australia', life: '6-8 Years', price: 150, volume: 'Quiet', friendly: true, intel: 'Rainbow Gem', category: 'finches', tag: 'Rainbow Finch', image: 'images/finch.png', care: 'Vibrant rainbow feathers, warmth sensitive, requires clean flight cage and millets.' },
        { name: 'Society Finch', sci: 'Lonchura striata', origin: 'Asia', life: '5-8 Years', price: 50, volume: 'Quiet', friendly: true, intel: 'Peaceful Nester', category: 'finches', tag: 'Gentle Flocker', image: 'images/finch.png', care: 'Extremely peaceful, loves communal nesting, brown and white feathered songster.' },
        { name: 'Owl Finch', sci: 'Taeniopygia bichenovii', origin: 'Australia', life: '6-8 Years', price: 130, volume: 'Quiet', friendly: true, intel: 'Ringed Eyed', category: 'finches', tag: 'Bicheno Finch', image: 'images/finch.png', care: 'Resembles miniature owl with distinct black face rings and white chest.' },
        { name: 'Star Finch', sci: 'Neochmia ruficauda', origin: 'Australia', life: '6-8 Years', price: 140, volume: 'Quiet', friendly: true, intel: 'Red-Faced Chirper', category: 'finches', tag: 'Star Dots', image: 'images/finch.png', care: 'Vivid red forehead and beak with tiny white star dots sprinkled on olive chest.' }
    ];
