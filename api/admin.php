...
function getUsers($db) {
    $stmt = $db->query("SELECT id, name, email, role, status, avatar, DATE_FORMAT(created_at, '%Y-%m-%d') AS joined_date FROM users ORDER BY id DESC");
    $users = $stmt->fetchAll();
...
function getUserActivity($db) {
    ...
    $userStmt = $db->prepare("SELECT id, name, email, role, status, created_at FROM users WHERE id = :id");
